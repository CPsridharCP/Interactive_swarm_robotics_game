...
G 				= [[70.0,80.0],[70.0,10.0],[70.0,40.0],[30.0,30.0],[30.0,60.0]]
H 				= [[30.0,20.0],[30.0,50.0],[30.0,80.0],[70.0,20.0],[70.0,50.0]]
I 				= [[50.0,10.0],[50.0,30.0],[50.0,50.0],[50.0,70.0],[50.0,90.0]]
J 				= [[30.0,40.0],[70.0,40.0],[50.0,20.0],[70.0,60.0],[70.0,80.0]]
K 				= [[30.0,20.0],[30.0,50.0],[30.0,80.0],[60.0,40.0],[60.0,60.0]]
L 				= [[50.0,20.0],[20.0,20.0],[20.0,50.0],[20.0,80.0],[70.0,20.0]]
M 				= [[20.0,20.0],[20.0,80.0],[80.0,20.0],[80.0,80.0],[50.0,60.0]]
N 				= [[35.0,80.0],[65.0,80.0],[50.0,50.0],[65.0,20.0],[35.0,20.0]]
...
T               = [[20.0,80.0],[50.0,20.0],[50.0,50.0],[50.0,80.0],[80.0,80.0]]
U  				= [[30.0,60.0],[70.0,60.0],[30.0,40.0],[70.0,40.0],[50.0,20.0]]
V               = [[50.0,25.0],[40.0,50.0],[60.0,50.0],[30.0,75.0],[70.0,75.0]]
W 				= [[20.0,80.0],[30.0,20.0],[50.0,50.0],[70.0,20.0],[80.0,80.0]]
...
def talker():
	...
	while not rospy.is_shutdown():
		...
		if (rospy.get_param("all_robot_localised")):
			...
			dist_mat = distance.cdist(goal_xy, robot_xy, 'cityblock')#euclidean') cityblock #DEMO USE CITY BLOCK
